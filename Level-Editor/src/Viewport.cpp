...
namespace SGF {
    Viewport::Viewport(VkFormat cFormat, VkFormat dFormat) : colorFormat(cFormat), depthFormat(dFormat) {
		...
		const std::vector<VkAttachmentDescription> attachments = {
			SGF::Vk::CreateAttachmentDescription(colorFormat, VK_SAMPLE_COUNT_1_BIT, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL, VK_ATTACHMENT_LOAD_OP_CLEAR),
